...
<div class="grid_3">
  ...
  <div class="col-md-9 profile_left1">
      ...
      <?php
       ...
       if(isset($_REQUEST["name"])!=null)
       {
           $_SESSION["name"]=$_REQUEST["name"];
       }
       $name=$_SESSION["name"];
       $starting_limit = ($page-1)*$limit;
       $sql="select u.name,u.profileid,u.MATRIMONYPROFILEFOR,u.gender,u.profile,u.religion,u.COUNTRYLIVINGIN,p.age,p.height,p.MARITAL_STATUS,pr.HIGHEST_EDUCATION from users u natural join  personal_details p  natural join professional_details pr where  u.name like '$name%' and u.gender!='$gender' limit $starting_limit,$limit";
...
<div class="col-md-3 match_right">
	<div class="profile_search1">
	   <form action="searchname" method="post">
		  <input type="text" class="m_1" name="name" required="" placeholder="Enter name :">
