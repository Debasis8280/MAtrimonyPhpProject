...
<div class="grid_3">
  ...
  <div class="col-md-9 profile_left1">
      ...
      ?></p>
      <?php
      require_once("../database/mainDatabase.php");
       ...
       {
           $_SESSION["searchid"]=$_REQUEST["id"];
       }
       $searchid=$_SESSION["searchid"];
       $starting_limit = ($page-1)*$limit;
       $sql="select u.name,u.profileid,u.MATRIMONYPROFILEFOR,u.gender,u.profile,u.religion,u.COUNTRYLIVINGIN,p.age,p.height,p.MARITAL_STATUS,pr.HIGHEST_EDUCATION from users u natural join  personal_details p  natural join professional_details pr where  u.profileid=$searchid and u.gender!='$gender' limit $starting_limit,$limit";
       ...
       $pst->execute();
           ...
           for ($page=$total_pages; $page <$total_pages ; $page++):
 ?>
