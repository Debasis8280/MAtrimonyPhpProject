...
<link href="../view/css/forgetpassword.css" rel="stylesheet" type="text/css" media="all"/>
<!-- Custom Theme files -->
...
<div class="elelment">
	...
	<div class="element-main">
		...
		<form action="changepassword" method="post"
			...
			<input type="password" name="password"  style="height: 35px; width: 350px;" placeholder="Password11414" id="password">
...
<script src="../view/jquery/jquery-2.1.3.min.js"></script>
	<script
		src="../view/jquery/jquery.validate.min.js"></script>
	<script
